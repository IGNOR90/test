...
function loadGIF() {
  ...
  oReq.onload = function(oEvent) {
    ...
    if (arrayBuffer) {
      gif = (0,_lib_index_js__WEBPACK_IMPORTED_MODULE_0__.parseGIF)(arrayBuffer)
      var frames = (0,_lib_index_js__WEBPACK_IMPORTED_MODULE_0__.decompressFrames)(gif, true)
      // render the gif
      renderGIF(frames)
    }
  }
